...
public class MediumBBlackTextView extends TextView {
    private Typeface mTypeface;

    public MediumBBlackTextView(Context context) {

        super(context);
    }

    public MediumBBlackTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
